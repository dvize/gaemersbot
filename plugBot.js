...
(function() {
  var AUTH, CSON, Plugbot, ROOM, announceFailure, announceWinner, answerFound, antispam, askQuestion, beggar, bot, botChatStarted, chatVarAssigned, checkAnswer, choice, choiceAnswer, choiceQuestion, cmdTrigger, createNewUser, dance, dances, fs, gameChatHandle, gameStarted, gameWinner, gameWinnerID, gameWon, getAnswer, getRank, getchatrank, giveHint, handleChat, handleChatDelete, handleHistory, handleRoomScores, hintGiven, http, initRanks, initialize, kill, loadGameTrivia, loadNewUsers, loadUserSaves, loadedNewUsers, loadedRanks, loadedSavedUsers, loadedTrivia, mytimer, newSong, notAsked, participant, participants, pickQuestion, playedBefore, questionhistory, randomInt, ranklist, ranklistitem, reconnect, resetGame, resetVars, room1, rouletteCheck, rouletteCounter, rouletteEntry, roulettestarted, roulettetimer, rparticipant, rparticipants, ruleAnnouncement, rules, server, skipCheck, songTimer, theme, timeSongs, timeSongsChat, timeSongsTwo, timer, timesup, topPlayedSongs, totalcurates, totalmehs, totalsonglistens, totalwoots, trivia, triviaGame, triviaStartCheck, triviaStarted, triviadata, triviafiles, updateScores, userWelcome, voteratio, weapons, writeHistory, writeSave, writeSkipping;
